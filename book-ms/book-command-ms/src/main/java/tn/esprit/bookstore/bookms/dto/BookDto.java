...
public record BookDto(Long id,String isbn,String title, Double price, String stock, String authorId , Author author, LocalDateTime createdAt, LocalDateTime updatedAt) {
